 ...
 */
public class RmVPathOverlay extends Overlay {
        // ===========================================================
        // Constants
        // ===========================================================
        ...
        public RmVPathOverlay(final int color, final Context ctx) {
                this(color, new DefaultResourceProxyImpl(ctx));
        }

        public RmVPathOverlay(final int color, final ResourceProxy pResourceProxy) {
